...
def preprocess_and_train(data):
    ...
    xgb = XGBClassifier(n_estimators=200, learning_rate=0.05, random_state=42, use_label_encoder=False, eval_metric='mlogloss')
    ...
    ensemble_model = StackingClassifier(estimators=estimators, final_estimator=VotingClassifier(estimators=estimators, voting='soft'))
